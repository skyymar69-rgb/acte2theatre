    ...
    <>
      ...
      >
        ...
        <div className="relative container max-w-5xl py-16 md:py-24 lg:py-28">
          ...
          >
            Privatisez Acte&nbsp;2 Théâtre pour vos
          ...
          <div className="flex flex-wrap gap-3">
            <a
              href="mailto:acte2theatre@yahoo.fr?subject=Demande%20de%20devis%20%E2%80%94%20Location%20Acte%202%20Th%C3%A9%C3%A2tre"
        ...
        <div className="rounded-2xl border border-or-500/30 bg-surface p-8 md:p-12 text-center shadow-scene">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            {[
              ...
              <a
                key={c.email}
                href={`mailto:${c.email}?subject=Demande%20de%20devis%20%E2%80%94%20Location%20Acte%202%20Th%C3%A9%C3%A2tre`}
